...
from GRUpredict import GRUpredict
...
if _platform == "win32":
    predict_obj = GRUpredict(model_file_path='..\data\model_gru\\', ground_truth_file_path='..\data\ground_truth_info\\', topk=5)
...
def calculate_score_for_test_data_chain():
    ...
    fig.savefig('gru_hr_06_08.png', dpi=300, bbox_extra_artists=(lgd,), bbox_inches='tight')
    ...
    plt.ylim(0, 1.1)
    lgd = ax.legend(loc='upper left', bbox_to_anchor=(1.05, 1), borderaxespad=0)         
    fig.savefig('gru_mrr_06_08.png', dpi=300, bbox_extra_artists=(lgd,), bbox_inches='tight')

    with open('gru_metrics_data', 'w') as output_file:
